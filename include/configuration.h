...
#define PREVENT_BAD_HOMING false

//Default Values
#define X_AXIS_HOMING_OFFSET 5
#define Y_AXIS_HOMING_OFFSET 5
#define Z_AXIS_HOMING_OFFSET 5
...
#define X_AXIS_ACCELLERATION 800
#define Y_AXIS_ACCELLERATION 800
#define Z_AXIS_ACCELLERATION 1000
